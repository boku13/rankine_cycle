...
fprintf('2-3 is Constant Pressure Heat Rejenction by the Condenser \n')
...
% Calculate volumes at each state using ideal gas equation
V1 = XSteam('v_ps', P1, S1) * 1e3;  % Convert m^3/kg to L/kg
V2 = XSteam('v_ps', P2, S2) * 1e3;
V3 = XSteam('v_ps', P3, S3) * 1e3;
V4 = XSteam('v_ps', P4, S4) * 1e3;
...
figure(3)
hold on
plot([V1 V2], [P1 P2], 'linewidth', 2, 'color', 'g')
plot([V2 V3], [P2 P3], 'linewidth', 2, 'color', 'g')
plot([V3 V4], [P3 P4], 'linewidth', 2, 'color', 'g')
plot([V4 V1], [P4 P1], 'linewidth', 2, 'color', 'g')
% Plot Cycle
plot([V1 V2 V3 V4 V1], [P1 P2 P3 P4 P1], 'linewidth', 2, 'color', 'r')
xlabel('Volume [L/kg]')
ylabel('Pressure [bar]')
title('P-V Diagram')

% Print volumes at each state
fprintf('\nVolumes at Each State (in L/kg):\n')
fprintf('V1: %.2f\n', V1)
fprintf('V2: %.2f\n', V2)
fprintf('V3: %.2f\n', V3)
fprintf('V4: %.2f\n', V4)
